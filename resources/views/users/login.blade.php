...
<body >
    <div class="main w-full h-[100vh] flex items-center">
        ...
        <div hidden class="login min-w-[30rem] w-[30rem] m-auto sm:border-1 rounded-[4px] sm:shadow-xl">
            ...
            <div class="form p-10">
                <div class="head">
                    <label for="formGroupExampleInput" class="form-label w-full text-[#ff4848] text-center text-xl font-bold mb-4">Login</label>
        ...
        <div class="signup min-w-[30rem] w-[30rem] m-auto sm:border-1 rounded-[4px] sm:shadow-xl">
            ...
            <div class="form p-10">
                <div class="head">
                    <div for="formGroupExampleInput" class="form-label w-full text-[#ff4848] text-center text-xl font-bold mb-4">Signup</div>
